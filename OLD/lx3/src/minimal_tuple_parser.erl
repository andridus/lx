-file("yecc/minimal_tuple_parser.yrl", 0).
-module(minimal_tuple_parser).
-file("src/minimal_tuple_parser.erl", 3).
...
-file("src/minimal_tuple_parser.erl", 196).
...
yeccpars2_6(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_tuple_elements(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).

%% yeccpars2_7: see yeccpars2_4
...
yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_tuple_elements(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
-dialyzer({nowarn_function, yeccgoto_tuple_elements/7}).
-compile({nowarn_unused_function,  yeccgoto_tuple_elements/7}).
yeccgoto_tuple_elements(4, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(5, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_tuple_elements(7=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr).

-compile({inline,yeccpars2_1_/1}).
-dialyzer({nowarn_function, yeccpars2_1_/1}).
-compile({nowarn_unused_function,  yeccpars2_1_/1}).
-file("yecc/minimal_tuple_parser.yrl", 5).
...
-file("yecc/minimal_tuple_parser.yrl", 6).
...
-file("yecc/minimal_tuple_parser.yrl", 10).
...
-file("yecc/minimal_tuple_parser.yrl", 11).
...
-file("yecc/minimal_tuple_parser.yrl", 8).
