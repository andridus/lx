...
fn test_new_list() {
	assert '[integer,1,1.5]' == new_list([new_atom('integer'),
		new_integer(1), new_float(1.5)]).to_string()
}
...
fn test_binary_to_term_atom() {
	...
	// max atom 255ch
	assert [u8(131), 119, 255, 76, 111, 114, 101, 109, 105, 112, 115, 117, 109, 100, 111, 108,
		111, 114, 115, 105, 116, 97, 109, 101, 116, 44, 99, 111, 110, 115, 101, 99, 116, 101, 116,
		117, 114, 97, 100, 105, 112, 105, 115, 99, 105, 110, 103, 101, 108, 105, 116, 46, 68, 111,
		110, 101, 99, 118, 117, 108, 112, 117, 116, 97, 116, 101, 101, 116, 97, 114, 99, 117, 116,
		105, 110, 99, 105, 100, 117, 110, 116, 105, 109, 112, 101, 114, 100, 105, 101, 116, 46,
		68, 117, 105, 115, 110, 111, 110, 109, 97, 103, 110, 97, 101, 114, 97, 116, 46, 81, 117,
		105, 115, 113, 117, 101, 110, 117, 110, 99, 112, 117, 114, 117, 115, 44, 32, 118, 111,
		108, 117, 116, 112, 97, 116, 101, 116, 116, 105, 110, 99, 105, 100, 117, 110, 116, 97,
		44, 114, 104, 111, 110, 99, 117, 115, 100, 105, 99, 116, 117, 109, 100, 111, 108, 111,
		114, 46, 68, 111, 110, 101, 99, 116, 105, 110, 99, 105, 100, 117, 110, 116, 101, 108, 101,
		105, 102, 101, 110, 100, 110, 117, 110, 99, 118, 101, 108, 118, 101, 110, 101, 110, 97,
		116, 105, 115, 46, 68, 111, 110, 101, 99, 98, 108, 97, 110, 100, 105, 116, 100, 105, 97,
		109, 101, 116, 68, 111, 110, 101, 99, 116, 105, 110, 99, 105, 100, 117, 110, 116, 101,
		108, 101, 105, 102, 101, 110, 105, 110, 99, 105, 100, 117, 110, 116, 105, 109, 112, 101,
		114, 100] == term_to_binary(new_atom('Loremipsumdolorsitamet,consecteturadipiscingelit.Donecvulputateetarcutinciduntimperdiet.Duisnonmagnaerat.Quisquenuncpurus, volutpatettincidunta,rhoncusdictumdolor.Donectincidunteleifendnuncvelvenenatis.DonecblanditdiametDonectincidunteleifeninciduntimperd'))!
...
fn test_binary_to_term_string() {
	assert new_string('string') == binary_to_term([u8(131), 109, 0, 0, 0, 6, 115, 116, 114, 105,
		110, 103])!
	assert new_string('') == binary_to_term([u8(131), 109, 0, 0, 0, 0])!
	assert new_string('nil') == binary_to_term([u8(131), 109, 0, 0, 0, 3, 110, 105, 108])!
	assert new_string('The development work is currently') == binary_to_term([u8(131), 109, 0,
		0, 0, 33, 84, 104, 101, 32, 100, 101, 118, 101, 108, 111, 112, 109, 101, 110, 116, 32,
		119, 111, 114, 107, 32, 105, 115, 32, 99, 117, 114, 114, 101, 110, 116, 108, 121])!
}
